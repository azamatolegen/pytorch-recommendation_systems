...
joblib.dump(user_mapping, "./dict_data/user_mapping.pkl.zip")
joblib.dump(item_mapping, "./dict_data/item_mapping.pkl.zip")
joblib.dump(movies_mapping, "./dict_data/movies_mapping.pkl.zip")
joblib.dump(inv_movies_mapping, "./dict_data/inv_movies_mapping.pkl.zip")
joblib.dump(inv_item_mapping, "./dict_data/inv_item_mapping.pkl.zip")
